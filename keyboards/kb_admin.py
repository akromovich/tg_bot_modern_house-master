...
excel_kb= ReplyKeyboardMarkup(resize_keyboard=True)
e_1 = KeyboardButton('A')
e_2 = KeyboardButton('Б')
e_3 = KeyboardButton('В')
e_4 = KeyboardButton('Г')
e_5 = KeyboardButton('общий excel')
e_6= KeyboardButton('orqaga')
excel_kb.add(e_1,e_2,e_3,e_4,e_5).add(e_6)